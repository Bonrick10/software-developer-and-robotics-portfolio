...
public class Portal extends Entity implements Overlapper {
    ...
    public boolean canMoveOnto(GameMap map, Entity entity) {
        if (pair == null)
            return false;
        if (entity instanceof Player || entity instanceof Mercenary || entity instanceof SnakeHead
            || entity instanceof SnakeBody)
