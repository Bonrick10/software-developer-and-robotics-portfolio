...
public class Player extends Entity implements Battleable, Overlapper {
    ...
    private int spawnerDestroyCount = 0;
    ...
    public int getSpawnerDestroyCount() {
        return spawnerDestroyCount;
    }

    public void addSpawnerDestroyCount() {
        this.spawnerDestroyCount++;
    }
    ...
    public void onOverlap(GameMap map, Entity entity) {
        System.out.println("onOverlap triggered");
        if (entity instanceof Enemy) {
            ...
            if (entity instanceof Bomb) {
                if (!((Bomb) entity).isSpawned()) {
                    return;
                }
                ((Bomb) entity).onPlayerOverlap(map, this);
            }
            ...
            map.moveTo(entity, this.getFacing());
        }
    }
